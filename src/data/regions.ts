    ...
    branches: [
      {
        ...
        name: 'Lagos Branch',
        regionId: 'REG-001',
        stationIds: ['STN-001', 'STN-003', 'STN-019', 'STN-020'],
      },
      {
        id: 'BRN-002',
    ...
    branches: [
      {
        ...
        name: 'Enugu Branch',
        regionId: 'REG-002',
        stationIds: ['STN-006', 'STN-010', 'STN-025', 'STN-034'],
      },
    ],
  },
  {
    ...
    branches: [
      ...
      },
      {
        ...
        name: 'Benin Branch',
        regionId: 'REG-003',
        stationIds: ['STN-008', 'STN-015', 'STN-018', 'STN-026', 'STN-035'],
      },
    ],
  },
  {
    ...
    branches: [
      {
        ...
        name: 'Abuja Branch',
        regionId: 'REG-004',
        stationIds: ['STN-002', 'STN-011', 'STN-024', 'STN-028', 'STN-029', 'STN-030'],
      },
      {
        id: 'BRN-007',
        name: 'Ilorin Branch',
